...
describe('Service Tests', () => {
    describe('Abc Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AbcService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/abcs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Abc', () => {
                service.create(new Abc(null)).subscribe(received => {
            ...
            it('should update a Abc', () => {
                service.update(new Abc(123)).subscribe(received => {
